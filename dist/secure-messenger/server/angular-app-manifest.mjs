...
export default {
  ...
  assets: {
    ...
    'index.server.html': {size: 1007, hash: '863f56c9ff677f2def6f07724076e57bc7609b78d0861da23eaa96812bd1d1e4', text: () => import('./assets-chunks/index_server_html.mjs').then(m => m.default)},
